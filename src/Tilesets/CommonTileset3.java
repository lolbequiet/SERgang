...
public class CommonTileset3 extends Tileset {
        ...
        public CommonTileset3() {
                super(ImageLoader.load("CommonTilesetV5.png"), 16, 16, 3);
        }
        ...
        public ArrayList<MapTileBuilder> defineTiles() {
                ...
                // left end branch
                Frame leftEndBranchFrame = new FrameBuilder(getSubImage(2, 3))
                                .withScale(tileScale)
                                .withBounds(0, 6, 16, 4)
                                .build();
                ...
                Frame crossSwordsFrame = new FrameBuilder(getSubImage(3, 2))
                                .withScale(tileScale)
                                .build();

                MapTileBuilder crossSwordsTile = new MapTileBuilder(grassFrame)
                                .withTopLayer(crossSwordsFrame)
                                .withTileType(TileType.NOT_PASSABLE);
                ...
                // grey rock
                Frame greyRockFrame = new FrameBuilder(getSubImage(3, 1))
                                .withScale(tileScale)
                                .build();
                ...
                // house body
                Frame houseBodyFrame = new FrameBuilder(getSubImage(3, 2))
                                .withScale(tileScale)
                                .build();
                ...
                // house roof body
                Frame houseRoofBodyFrame = new FrameBuilder(getSubImage(1, 2))
                                .withScale(tileScale)
                                .build();
                ...
                // left house roof
                Frame leftHouseRoofFrame = new FrameBuilder(getSubImage(2, 2))
                                .withScale(tileScale)
                                .build();
                ...
                // left window
                Frame leftWindowFrame = new FrameBuilder(getSubImage(1, 1))
                                .withScale(tileScale)
                                .build();
                ...
                // door
                Frame doorFrame = new FrameBuilder(getSubImage(2, 3))
                                .withScale(tileScale)
                                .build();
                ...
                Frame portal = new FrameBuilder(getSubImage(0, 3))
                                .withScale(tileScale)
                                .build();
